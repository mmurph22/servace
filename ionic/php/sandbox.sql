...
-- Procedures
--
DROP PROCEDURE IF EXISTS `getrequiredstaff`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `getrequiredstaff` (IN `eventiid` INT, OUT `reqstaff` DECIMAL)  BEGIN
  /* Procedure text */
END$$
...
INSERT INTO `collisions` (`id`, `species`, `gender`, `age`, `report_date`, `location`, `latitude`, `longitude`, `img_url`) VALUES
(16, 'Dolphin', 'Female', 'Adult', '2017-02-23 22:31:00', 'off the Jersey Shore', 40.000000, -75.000000, './uploads/basketball.jpg'),
(17, 'Pig', 'Male', 'Adult', '2017-12-25 17:30:00', 'at my Christmas dinner', 40.000000, -75.000000, './uploads/buffalo.jpg'),
(18, 'Albatross', 'Male', 'Adult', '2018-02-06 12:35:00', 'on the Isle of Man', 39.534000, -76.486000, './uploads/apg_gate.jpg'),
(14, 'Fox', 'Unknown', 'Juvenile', '2018-04-01 18:30:00', 'at the ice cream shoppe', 40.000000, -75.000000, './uploads/grandteton2.jpg'),
(15, 'McFly', 'Male', 'Unknown', '1955-11-05 15:30:00', 'in front of Lorains house', 40.000000, -75.000000, './uploads/ryland.jpg'),
(19, 'Rat', 'Male', 'Unknown', '2018-05-02 06:00:00', 'under the stairs', 37.654999, -79.455299, NULL);
